...
ExecStart       = /home/pi/myssd/tezos/tezos-baker-011-PtHangz2 --endpoint http://127.0.0.1:8732 run with local node ~/myssd/tezos-node ledger_pi && export TEZOS_LOG="* -> debug"
Restart         = always
